...
import SliderFeatures from '../../SliderFeatures/Features';
import SliderTradeAnywhere from '../../SliderTradeAnywhere/TradeAnywhere';
import SliderGetInTouch from '../../SliderGetInTouch/SliderGetInTouch';
import './MainPage.css';
                    ...
                    <div className="row m-0">
                        <MainSlider/>
                            <section className="register-and-exchange">
                                <div className="register-and-exchange_wrapper col-xl-6 col-lg-6 col-md-12 col-sm-12 px-0">
                                    <p className="register-and-exchange_title">Buy & Sell Crypto, Easy & Secure</p>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12 px-0 pl-xl-5 pl-lg-3">
                                    <Exchange/>
                                </div>
                            </section>
                            <div className="container p-0">
                                <div className="row m-0">
                                    <div className="markets p-0 col-xl-12 col-lg-12 col-md-10 col-sm-11 col-11">
                                        ...
                                        <div className="markets-items"> 
                                            <div className="markets-items_item">
                                                ...
                                                <p className="markets-items_item-abbreviation">ETH<span className="markets-items_item-name-Ethereum-665">Ethereum</span></p>
                                            ...
                                            <div className="markets-items_item">
                                                ...
                                                <p className="markets-items_item-abbreviation">BTC<span className="markets-items_item-name-BTC-665">BTC</span></p>
                                            ...
                                            <div className="markets-items_item">
                                                ...
                                                <p className="markets-items_item-abbreviation">BNB<span className="markets-items_item-name-BNB-665">BNB</span></p>
                                            ...
                                            <div className="markets-items_item">
                                                ...
                                                <p className="markets-items_item-abbreviation">LINK<span className="markets-items_item-name-LINK-665">LINK</span></p>
                                            ...
                                            <div className="markets-items_item">
                                                ...
                                                <p className="markets-items_item-abbreviation">1 INCH<span className="markets-items_item-name-1-INCH-665">1 INCH</span></p>
                            ...
                            <div className="container p-0">
                                <div className="row m-0">
                                    <div className="statistics col-xl-12 col-lg-12 col-md-10 col-sm-11 col-11">
                                        <div className="statistics-item col-xl-3 col-lg-3 col-md-3 col-sm-5 col-5">
                                        ...
                                        <div className="statistics-item col-xl-3 col-lg-3 col-md-3 col-sm-10 col-10">
                            ...
                            <div className="container p-0">
                                ...
                                <div className="features_content">
                                    <SliderFeatures className="deleteSlider"/>
