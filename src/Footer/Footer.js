        ...
        return (
            <footer className="footer">
                <div className="container p-0">
                    ...
                    <div className="row m-0 m-auto col-xl-12 col-lg-12 col-md-10 col-sm-11 footer_href">
                        <div className="footer-info p-0 col-xl-2 col-lg-2 col-md-3 col-sm-3">
                            <ul>
                                <li>
                                    <h5>About</h5>
                                </li>
                        ...
                        <div className="footer-contact-us p-0 m-0 col-xl-2 col-lg-2 col-md-10">
                            <h5>Contact us</h5>
                            ...
                            <div className="row">
                            <div className="social-icons col-xl-12 col-md-9">
                                <span>
                            ...
                            <div className="sel col-xl-12 col-md-3">
